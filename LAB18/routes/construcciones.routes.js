...
router.get('/construir', isAuth, construccionesController.get_construir); // Nuevo controlador con get construir

router.post('/construir', isAuth, construccionesController.post_construir); // Nuevo controlador con post construir
...
router.get('/', isAuth, construccionesController.get_root); // Nuevo controlador con get raiz
