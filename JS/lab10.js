        ...
        <body>
            <nav class="navbar" role="navigation" aria-label="main navigation">
                ...
                <a class="navbar-item" href="/">
                    <img src="https://static.wikia.nocookie.net/siivagunner/images/a/ac/Starbound.jpg/revision/latest?cb=20190917080905" width="112" height="28">
                </a>
...
const server = http.createServer((request, response) => {
    ...
    if (request.url == "/") {
      ...
      response.end();
        ...
        response.write(footer);
        response.end();
      } else if (request.url == '/planetas' && request.method == 'POST') {
        ...
        return request.on('end', () => { // Esta función devolvera lo enviado por on en forma de texto
            ...
            response.setHeader('Location', '/'); // URL a la que refirigir 
            response.end();
