...
const canView = require('../util/can-view1');
const canRegister = require('../util/can-register');
...
router.get('/planetas/:planeta_id', isAuth, canView, planetasController.get_planetas);
